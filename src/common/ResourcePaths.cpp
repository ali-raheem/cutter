...
QStringList Cutter::locateAll(QStandardPaths::StandardLocation type, const QString &fileName, QStandardPaths::LocateOptions options)
{
    // This function is reimplemented here instead of forwarded to Qt becauase existence check needs to be done after substitutions
    QStringList result;
...
{
    auto result = locateAll(QStandardPaths::DataLocation, "translations", QStandardPaths::LocateDirectory);
